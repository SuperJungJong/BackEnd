...
@Component
class MonoRentBatchReader(
    private val monoRentQueryPort: SearchMonoRentQueryPort,
) : ItemStreamReader<MonoRent> {
    ...
    private val CURRENT_ID_KEY = "batch.mono.rent.id"
    var monoRentList: List<MonoRent> = ArrayList()
    var dealYm: Int = 0
    ...
    override fun read(): MonoRent? {
        ...
        val get = monoRentList.get(currentId)
        currentId++
